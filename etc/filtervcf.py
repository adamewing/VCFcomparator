...
if __name__ == '__main__':
    ...
    parser.add_argument('-f', '--filterfile', dest='ff', required=True, 
                        help='File with filter parameters. Format (whitespace delimited): <field>(INFO or FORMAT) <tag> <direction>(LT or GT) <value> <sample name>(FORMAT only)')
